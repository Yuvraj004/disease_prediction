        ...
        <div>
            ...
            <div>
                ...
                <div className="divide-y divide-gray-100" key={index}>
                    <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-10 align-items-center">
                        <dt className="text-sm font-medium leading-6 text-gray-900 ">{index}</dt>
                        <dd className="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">{columnName}</dd>
                    </div>
                </div>
            ))}
            </div>
